...
#docker run -v ~/output:/opt/notebooks/output -p 3123:3123 --rm -it --gpus '"device=0"' tab-survey
docker run --shm-size=16G -v ~/output:/opt/notebooks/output -p 3123:3123 --rm -it --gpus all tab-survey
